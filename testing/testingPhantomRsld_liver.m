...
dataDir = 'C:\Users\sebas\Documents\Data\Nonlinearity\adriana2';
refDir = 'C:\Users\sebas\Documents\Data\Nonlinearity\adriana2';
% refDir = dataDir;
resultsDir = fullfile(dataDir,'results_liver');
[~,~,~] = mkdir(resultsDir);
targetFiles = dir([dataDir,'\*beef*.mat']);

%%
blocksize = 16;     % Block size in wavelengths
freq_L = 3.5e6; freq_H = 6.5e6;
...
% For looping
refFiles = dir(fullfile(refDir,'psdata_refRSLD_2*'));
