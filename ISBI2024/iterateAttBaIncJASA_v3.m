...
setup;
baseDir = fullfile(pwd,"data","nonUniformSimulation");
resultsDir = fullfile(pwd,"results","nonUniformSimulation","ba6inc12New");
[~,~,~] = mkdir(resultsDir);
refDir = fullfile(pwd,"data","nonUniformSimulation","newRef");
