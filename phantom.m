...
att_ref = 0.54; % From phantom especifications
...
figure('Units','centimeters', 'Position',[5 5 21 7]);
...
legend('wSLD',sprintf('AC=%.2f%+.2ff\n',zcSwift,acsSwift), 'Location','northwest')
