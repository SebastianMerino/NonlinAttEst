...
% fileSam = 'rf_fnum3_SCOMP6MHz_nc10_0p10f2_sam400_doubleangle720';
...
%%
% figDir = 'C:\Users\sebas\Documents\MATLAB\totalvarsimul_AC_BA\figures';
% save_all_figures_to_directory(figDir,...
%     sprintf("alpha0p%.0f_BA%.0f_fig",alpha0/freq^2*100,2*(beta0-1)));