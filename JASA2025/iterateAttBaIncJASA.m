...
resultsDir = fullfile(baseDir,'results','ba6Inc9JASA_refBA6att0p1');
% baseDir = 'C:\Users\sebas\Documents\Data\Nonlinearity\uniformBA_inclusionACS';
% resultsDir = fullfile(baseDir,'results');
[~,~,~] = mkdir(resultsDir);
refDir = "C:\Users\sebas\Documents\Data\Nonlinearity\attIncRef\fn2";
...
for iSim=1:length(alphaIncVec)
    ...
    fileSam = "RFfn2_PWNE"+freq+"MHz_samincBA6inc9_att0p1f2inc0p"+alphaStr+ ...
            "_nc10_400kPa";
    fileRef = "RFfn2_PWNE"+freq+"MHz_refBA6_att0p10f2_nc10_400kPa";
    ...
    %% Plots
    figure;
    im = imagesc(xB*1e3,zB*1e3,estACinst); colorbar;
    clim(attRange);
    ...
    figure; imagesc(xB*1e3,zB(2:end)*1e3,estBAinst); colorbar;
    clim(baRange);
    title('GN, B/A');
    axis image
