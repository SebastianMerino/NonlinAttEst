...
element_length  = 5e-3;         % measured from L11-4v
...
for iFreq = 1:length(tone_burst_freq_vector)
    ...
    for ss = 1:length(source_strength_vector)
        ...
        for aa = 1:8
            ...
            filename = fullfile(pwd,"random_media_new","BAPW_STD2_REF2025_"+aa+".mat");
        ...
        file_out = ['PWNE',num2str(round(tone_burst_freq/1e6)), ...
            'MHz_ref_att0p1f',num2str(alpha_power*10),...
